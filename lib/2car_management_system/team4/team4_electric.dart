...
import 'package:team_husky/2car_management_system/team4/team4_electric_card.dart';

class Team4Electric extends StatefulWidget {
  const Team4Electric({super.key});

  @override
  State<Team4Electric> createState() => _Team4ElectricState();
}

class _Team4ElectricState extends State<Team4Electric> {
  ...
  Future<String> createClipboardText2(String address) async {
    final query = await FirebaseFirestore.instance
        .collection(TEAM4ELECTRICLIST + address)
        .orderBy('enter')
        .get();
  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
      stream: FirebaseFirestore.instance
          .collection(TEAM4ELECTRICLIST + adress)
          .orderBy('enter')
          .snapshots(),
