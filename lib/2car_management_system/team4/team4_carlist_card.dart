...
class Team4CarListCard extends StatelessWidget {
  final int index;
  final String carNum;
  ...
  const Team4CarListCard({super.key,
    required this.index,
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          _buildCell(width: 60, text: Team4getInTime(inTime)),
          _buildCell(
            width: 55,
            text: outTime != null ? Team4getOutTime(outTime!) : '11:00',
