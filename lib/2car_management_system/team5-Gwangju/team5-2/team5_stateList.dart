...
import 'package:team_husky/2car_management_system/team5-Gwangju/team5-2/team5_stateList_card.dart';

import '../team5_adress.dart';

class Team5Statelist extends StatefulWidget {
  final String dataId;

  const Team5Statelist({super.key, required this.dataId});
  @override
  State<Team5Statelist> createState() => _Team5StatelistState();
}

class _Team5StatelistState extends State<Team5Statelist> {
